...
var getPeriods = function(dateDeValeur) {
    return {
        moisCourant: {
            key: moment(dateDeValeur).format('YYYY-MM')
        },
        moisPrecedent: {
            key: moment(dateDeValeur).subtract(1, 'months').format('YYYY-MM')
        },
        moisMMoins2: {
            key: moment(dateDeValeur).subtract(2, 'months').format('YYYY-MM')
        },
        moisMMoins3: {
            key: moment(dateDeValeur).subtract(3, 'months').format('YYYY-MM')
        },
       anneeGlissante: {
